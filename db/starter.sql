...
--
-- Name: starter_app_message; Type: TABLE; Schema: public; Owner: -; Tablespace: 
--

CREATE TABLE starter_app_message (
    id integer NOT NULL,
...
--
-- Name: starter_app_message_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE starter_app_message_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: starter_app_message_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE starter_app_message_id_seq OWNED BY starter_app_message.id;
...
ALTER TABLE ONLY starter_app_message ALTER COLUMN id SET DEFAULT nextval('starter_app_message_id_seq'::regclass);
...
1	contenttypes	0001_initial	2015-09-30 17:45:22.367605+02
2	auth	0001_initial	2015-09-30 17:45:22.410512+02
3	admin	0001_initial	2015-09-30 17:45:22.427761+02
4	contenttypes	0002_remove_content_type_name	2015-09-30 17:45:22.469258+02
5	auth	0002_alter_permission_name_max_length	2015-09-30 17:45:22.483709+02
6	auth	0003_alter_user_email_max_length	2015-09-30 17:45:22.494627+02
7	auth	0004_alter_user_username_opts	2015-09-30 17:45:22.505151+02
8	auth	0005_alter_user_last_login_null	2015-09-30 17:45:22.517557+02
9	auth	0006_require_contenttypes_0002	2015-09-30 17:45:22.519464+02
10	sessions	0001_initial	2015-09-30 17:45:22.529715+02
11	starter_app	0001_initial	2015-09-30 17:45:22.539642+02
\.
...
--
-- Data for Name: starter_app_message; Type: TABLE DATA; Schema: public; Owner: -
--
...
--
-- Name: starter_app_message_pkey; Type: CONSTRAINT; Schema: public; Owner: -; Tablespace: 
--

ALTER TABLE ONLY starter_app_message
    ADD CONSTRAINT starter_app_message_pkey PRIMARY KEY (id);
